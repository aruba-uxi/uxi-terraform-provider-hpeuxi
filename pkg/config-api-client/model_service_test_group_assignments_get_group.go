...
// checks if the ServiceTestGroupAssignmentsGetGroup type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceTestGroupAssignmentsGetGroup{}
...
type _ServiceTestGroupAssignmentsGetGroup ServiceTestGroupAssignmentsGetGroup
...
func NewServiceTestGroupAssignmentsGetGroup(id string) *ServiceTestGroupAssignmentsGetGroup {
	this := ServiceTestGroupAssignmentsGetGroup{}
	this.Id = id
	return &this
}
...
func (o *ServiceTestGroupAssignmentsGetGroup) UnmarshalJSON(data []byte) (err error) {
	...
	varServiceTestGroupAssignmentsGetGroup := _ServiceTestGroupAssignmentsGetGroup{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varServiceTestGroupAssignmentsGetGroup)

	if err != nil {
		return err
	}

	*o = ServiceTestGroupAssignmentsGetGroup(varServiceTestGroupAssignmentsGetGroup)

	return err
}

type NullableServiceTestGroupAssignmentsGetGroup struct {
	value *ServiceTestGroupAssignmentsGetGroup
	isSet bool
}

func (v NullableServiceTestGroupAssignmentsGetGroup) Get() *ServiceTestGroupAssignmentsGetGroup {
	return v.value
}

func (v *NullableServiceTestGroupAssignmentsGetGroup) Set(
	val *ServiceTestGroupAssignmentsGetGroup,
) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceTestGroupAssignmentsGetGroup) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceTestGroupAssignmentsGetGroup) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceTestGroupAssignmentsGetGroup(
	val *ServiceTestGroupAssignmentsGetGroup,
) *NullableServiceTestGroupAssignmentsGetGroup {
	return &NullableServiceTestGroupAssignmentsGetGroup{value: val, isSet: true}
}

func (v NullableServiceTestGroupAssignmentsGetGroup) MarshalJSON() ([]byte, error) {
