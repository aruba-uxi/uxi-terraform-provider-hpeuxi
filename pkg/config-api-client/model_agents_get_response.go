...
// checks if the AgentsGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AgentsGetResponse{}
...
type _AgentsGetResponse AgentsGetResponse
...
func (o *AgentsGetResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAgentsGetResponse := _AgentsGetResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAgentsGetResponse)

	if err != nil {
		return err
	}

	*o = AgentsGetResponse(varAgentsGetResponse)

	return err
}

type NullableAgentsGetResponse struct {
	value *AgentsGetResponse
	isSet bool
}

func (v NullableAgentsGetResponse) Get() *AgentsGetResponse {
	return v.value
}

func (v *NullableAgentsGetResponse) Set(val *AgentsGetResponse) {
	v.value = val
	v.isSet = true
}
...
func NewNullableAgentsGetResponse(val *AgentsGetResponse) *NullableAgentsGetResponse {
	return &NullableAgentsGetResponse{value: val, isSet: true}
}
