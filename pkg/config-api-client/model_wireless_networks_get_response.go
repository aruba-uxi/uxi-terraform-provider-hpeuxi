...
// checks if the WirelessNetworksGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WirelessNetworksGetResponse{}
...
type _WirelessNetworksGetResponse WirelessNetworksGetResponse
...
func NewWirelessNetworksGetResponse(
	...
	this := WirelessNetworksGetResponse{}
	this.Items = items
	this.Count = count
	this.Next = next
	return &this
...
func (o *WirelessNetworksGetResponse) GetItems() []WirelessNetworksGetItem {
	if o == nil {
		var ret []WirelessNetworksGetItem
		return ret
	}
...
func (o *WirelessNetworksGetResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varWirelessNetworksGetResponse := _WirelessNetworksGetResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varWirelessNetworksGetResponse)

	if err != nil {
		return err
	}

	*o = WirelessNetworksGetResponse(varWirelessNetworksGetResponse)

	return err
}

type NullableWirelessNetworksGetResponse struct {
	value *WirelessNetworksGetResponse
	isSet bool
}

func (v NullableWirelessNetworksGetResponse) Get() *WirelessNetworksGetResponse {
	return v.value
}

func (v *NullableWirelessNetworksGetResponse) Set(val *WirelessNetworksGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableWirelessNetworksGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableWirelessNetworksGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWirelessNetworksGetResponse(
	val *WirelessNetworksGetResponse,
) *NullableWirelessNetworksGetResponse {
	return &NullableWirelessNetworksGetResponse{value: val, isSet: true}
}
